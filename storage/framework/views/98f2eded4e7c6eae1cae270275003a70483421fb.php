...
<div class="row">
    <div class=" d-flex justify-content-between">
        ...
        <div>
            <button type="button" class="btn btn-success" ><a href="/questionbank/addquestion/<?php echo e($questionBank["id"]); ?>" class="white_a">Ekle</a></button>
...
<div class="card mr-1 ml-2 mb-5 float-left" style="width: 18rem;">
    <div class="card-body">
     ...
     <div class="ml-5 mr-5">
        ...
        <a href="/deletequestion/<?php echo e($question->id); ?>" class="btn btn-danger">Sil</a>
     </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\classroom-management\resources\views/questionbank/show-question.blade.php ENDPATH**/ ?>