...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Şifreyi Tekrarla</label>
...
</style><?php /**PATH F:\bitirme\classroom-management\resources\views/auth/register.blade.php ENDPATH**/ ?>